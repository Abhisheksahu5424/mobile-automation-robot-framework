...
Capture And Validate App Screens
    ...
    sleep    3s
    Assert Visual Match    ${BASELINE_DIR}/00_app_opened.png    ${SCREENSHOT_DIR}/00_app_opened.png    ${Threshold} 
    Sleep    3s

    # Additional page snapshots
    Take App Screenshot    01_after_each_page_load
    sleep    3s
    Assert Visual Match    ${BASELINE_DIR}/01_after_each_page_load.png    ${SCREENSHOT_DIR}/01_after_each_page_load.png   ${Threshold} 
    Sleep    3s

    Take App Screenshot    02_splash
    sleep    3s
    Assert Visual Match    ${BASELINE_DIR}/02_splash.png    ${SCREENSHOT_DIR}/02_splash.png    ${Threshold} 
    Sleep    3s

    Take App Screenshot    03_main_page
    sleep    3s
    Assert Visual Match    ${BASELINE_DIR}/03_main_page.png    ${SCREENSHOT_DIR}/03_main_page.png    ${Threshold} 
    Sleep    3s
    ...
    sleep    3s
    Assert Visual Match    ${BASELINE_DIR}/04_after_click_continue.png    ${SCREENSHOT_DIR}/04_after_click_continue.png   ${Threshold}
    Sleep    3s

    Take App Screenshot    05_Continue_to_next_page
    sleep    3s
    Assert Visual Match    ${BASELINE_DIR}/05_Continue_to_next_page.png    ${SCREENSHOT_DIR}/05_Continue_to_next_page.png    ${Threshold}
    Sleep    3s
